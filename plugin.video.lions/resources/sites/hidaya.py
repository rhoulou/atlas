...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/hidaya.png'
...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'ISLAM_QURAN', LOGO, oOutputParameterHandler)
