...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/asiaarabs.png'
...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'أفلام', LOGO, oOutputParameterHandler)
