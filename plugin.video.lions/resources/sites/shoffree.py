...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/shoffree.png'
...
def load():
    ...
    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', True)
    oGui.addDir(SITE_IDENTIFIER, 'showLangsM', 'افلام حسب اللغة', LOGO, oOutputParameterHandler)
