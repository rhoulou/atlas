...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/witanime.png'
...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showSearch', addons.VSlang(30118), LOGO, oOutputParameterHandler)
