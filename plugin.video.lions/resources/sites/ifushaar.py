...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/ifushaar.png'
...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'أفلام أجنبية', LOGO, oOutputParameterHandler)
    ...
    oGui.addDir(SITE_IDENTIFIER, MOVIE_TRE[1], 'أفلام (شائع)', LOGO, oOutputParameterHandler)

    oOutputParameterHandler.addParameter('siteUrl', MOVIE_REC[0])
    oGui.addDir(SITE_IDENTIFIER, MOVIE_REC[1], 'أفلام (الاحدث)', LOGO, oOutputParameterHandler)
    
    oOutputParameterHandler.addParameter('siteUrl', MOVIE_TOP[0])
    oGui.addDir(SITE_IDENTIFIER, MOVIE_TOP[1], 'أفلام (الاكثر مشاهدة)', LOGO, oOutputParameterHandler)
