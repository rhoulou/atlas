...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/egydead.png'
...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'افلام اجنبي', LOGO, oOutputParameterHandler)
