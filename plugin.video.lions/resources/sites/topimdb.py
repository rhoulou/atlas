...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/topimdb.png'
...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, MOVIE_WORLD[1], 'Top Films Mondial',LOGO, oOutputParameterHandler)
