...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/cinemana.png'
...
def load():
    ...
    oOutputParameterHandler.addParameter('siteUrl', 'http://venom/')
    oGui.addDir(SITE_IDENTIFIER, 'showSeriesSearch', addons.VSlang(30079), LOGO, oOutputParameterHandler)
