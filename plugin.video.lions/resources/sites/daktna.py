...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/daktna.png'
...
URL_SEARCH = (URL_MAIN + '/?s=', 'showSearchSeries')
...
def showSearchSeries(sSearch = ''):
    ...
    if aResult[0]:
        ...
        for aEntry in aResult[1]:
            ...
            sMovieTitle = sTitle.split('الحلقة')[0]
            sEp = sTitle.replace("الحلقة","E")
            sEp = sEp.split('E')[1]
            sEp = sEp.split('ال')[0]
            sYear = ''
