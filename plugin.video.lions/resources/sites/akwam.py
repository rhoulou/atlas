...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/akwam.png'
...
def load():
    ...
    oOutputParameterHandler.addParameter('siteUrl', 'http://venom/')
    oGui.addDir(SITE_IDENTIFIER, 'showSearchAll', 'Search All', LOGO, oOutputParameterHandler)
...
def showMovies(sSearch = ''):
    ...
    oRequestHandler.addHeaderEntry('Accept-Language', 'ar,ar;q=0.9,en;q=0.5')
