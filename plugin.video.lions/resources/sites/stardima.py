...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/stardima.png'
...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showSearchMovies', 'SEARCH_MOVIES', LOGO, oOutputParameterHandler)

    oOutputParameterHandler.addParameter('siteUrl', 'http://venom/')
    oGui.addDir(SITE_IDENTIFIER, 'showSearchSeries', 'SEARCH_SERIES', LOGO, oOutputParameterHandler)
