...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/topcinema.png'
...
def load():
    ...
    oOutputParameterHandler.addParameter('siteUrl', 'http://venom/')
    oGui.addDir(SITE_IDENTIFIER, 'showSearchSeries', addons.VSlang(30079), LOGO, oOutputParameterHandler)
