...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/cima4u.png'

SITE_IDENTIFIER = 'cima4u'
SITE_NAME = 'Cima4u'
...
MOVIE_EN = ('', 'showMovies', 2)
MOVIE_AR = ('', 'showMovies', 16515)
MOVIE_ASIAN = ('', 'showMovies', 6694)
MOVIE_TR = ('', 'showMovies', 6810)
MOVIE_HI = ('', 'showMovies', 13409)
ANIM_MOVIES = ('', 'showMovies', 1154)
KID_MOVIES = ('', 'showMovies', 18)

SERIE_EN = ('', 'showSeries', 7)
SERIE_AR = ('', 'showSeries', 20)
SERIE_ASIA = ('', 'showSeries', 47)
SERIE_TR = ('', 'showSeries', 139)
SERIE_HI = ('', 'showSeries', 7064)
ANIM_SERIES = ('', 'showSeries', 100)
KID_SERIES = ('', 'showSeries', 417)
SERIE_DOC = ('', 'showSeries', 431)
...
def load():
    ...
    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('catId', SERIE_HI[2])
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showSeries', 'مسلسلات أنمي', icons + '/Anime.png', oOutputParameterHandler)

    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('catId', KID_SERIES[2])
    oGui.addDir(SITE_IDENTIFIER, 'showSeries', 'مسلسلات كرتون', icons + '/Cartoon.png', oOutputParameterHandler)

    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('catId', SERIE_DOC[2])
    oGui.addDir(SITE_IDENTIFIER, 'showSeries', 'وثائقيات', icons + '/Documentary.png', oOutputParameterHandler)
...
def showMovies(sSearch=''):
    ...
    for post in posts:
        ...
        sDisplay = sTitle.replace('مشاهدة', '').replace('فيلم', '').replace('مسلسل', '').replace('اون لاين', '').replace('اونلاين', '').replace('مترجم', '').replace('مدبلج', '').replace('حصرى', '').replace('مترجمة', '').replace('مدبلجة', '').replace('على اكثر من سيرفر', '').strip()
