...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/pakistani.png'
...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', 'أفلام-باكستانية', LOGO, oOutputParameterHandler)
