...
LOGO = 'special://home/addons/plugin.video.lions/resources/sites/logos/watanflix.png'
...
def load():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showSeries', 'أفلام عربية', LOGO, oOutputParameterHandler)
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showSeries', 'برامج', LOGO, oOutputParameterHandler)
