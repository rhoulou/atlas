...
from resources.lib.comaddon import addon, isLions, isNexus
...
class cGuiElement:
    ...
    def __init__(self):
        ...
        self.__sRootArt = 'special://home/addons/plugin.video.lions/resources/art/' + self.addons.getSetting('defaultIcons')
        self.__sType = 'video'
        self.__sMeta = 0
        self.__sTrailer = ''
    ...
    def getIcon(self):
        ...
        folder = 'special://home/addons/plugin.video.lions/resources/art'
