    ...
    def main(self, env):
        ...
        if (env == 'resolveurl'):
            ...
            if self.DIALOG.VSyesno(self.ADDON.VSlang(30456)):
                cached_Cache = "special://home/userdata/addon_data/plugin.video.lions/video_cache.db"
            ...
            cached_DB = "special://home/userdata/addon_data/plugin.video.lions/matrix.db"
            # important seul xbmcvfs peux lire le special
            try:
        ...
        # aciver/désactiver les sources
            ...
            class XMLDialog(xbmcgui.WindowXMLDialog):
                ...
                def onInit(self):
                    ...
                    for aPlugin in aPlugins:
                        ...
                        icon = "special://home/addons/plugin.video.lions/resources/art/sites/%s.png" % sPluginName
            ...
            path = "special://home/addons/plugin.video.lions"
            ...
            DB = "special://home/userdata/addon_data/plugin.video.lions/matrix.db"
            if select >= 0:
                try:
                    if select == 0:
