...
from resources.lib.comaddon import addon, dialog, VSlog, VSPath, isLions, xbmc
...
class cTMDb:
    ...
    CACHE = 'special://home/userdata/addon_data/plugin.video.lions/video_cache.db'
    ...
    def getToken(self):
        ...
        if (total > 0):
            ...
            if not xbmc.getCondVisibility('system.platform.android'):
                ...
                qr.png(VSPath('special://home/userdata/addon_data/plugin.video.lions/qrcode.png'), scale=5)
                oSolver = cInputWindowYesNo(captcha='special://home/userdata/addon_data/plugin.video.lions/qrcode.png', msg="Scanner le QRCode pour acceder au lien d'autorisation", roundnum=1)
                retArg = oSolver.get()
                DIALOG = dialog()
                if retArg == "N":
                    return False
