...
from resources.lib.comaddon import isLions
import xbmcgui
import xbmc
import xbmcvfs
...
#    def __init__(self, image: bytes, width: int, height: int):
    ...
    def create_temp_image(self):
        ...
        filePath = 'special://home/userdata/addon_data/plugin.video.lions/Captcha.raw'
    ...
    def border_img_path(self):
        path = "special://home/addons/plugin.video.lions/resources/lib/waaw/resources/media/border90.png"
        if isLions():
    ...
    def add_controls(self):
        ...
        captcha_image = xbmcgui.ControlImage(
            ...
            self.frame_x, self.frame_y, self.width, self.height, 'special://home/userdata/addon_data/plugin.video.lions/Captcha.raw'
        )
