...
from resources.lib.comaddon import dialog, addon, VSlog, VSPath, isLions, VSProfil
...
class cDb(object):
    def __enter__(self):
        ...
        if name == 'Master user':
            ...
            DB = 'special://home/userdata/profiles/' + name + '/addon_data/plugin.video.lions/matrix.db'
