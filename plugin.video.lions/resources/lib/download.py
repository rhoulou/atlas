...
from resources.lib.comaddon import addon, dialog, progress, VSlog, VSupdate, VSPath, isLions
...
class cDownload:
    ...
    def getDownload(self):
        ...
        item.setArt({'icon':'special://home/addons/plugin.video.lions/resources/art/' + icons + '/DownloadStart.png'})
