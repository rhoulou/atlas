...
class cLibrary:
    ...
    def __init__(self):
        ...
        if not self.__sMovieFolder:
            self.__sMovieFolder = 'special://userdata/addon_data/plugin.video.lions/Films'
        ...
        if not self.__sTVFolder:
            self.__sTVFolder = 'special://userdata/addon_data/plugin.video.lions/Series'
    ...
    def setLibrary(self):
        ...
        sLink = 'plugin://plugin.video.lions/?function=play&site=cHosterGui&sFileName='
    ...
    def getRecords(self):
        ...
        if not folder:
            folder = 'special://userdata/addon_data/plugin.video.lions/Enregistrement"/>'
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', folder)
